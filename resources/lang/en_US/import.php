...
return [
    ...
    'job_config_fints_tan_device_help'  => 'The name of the device on which you receive your TANs. Must only be given, if there is a corresponding error shown in the next step.',
